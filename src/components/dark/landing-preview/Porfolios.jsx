...
function Porfolios() {
  return (
    <section data-scroll-index="4" className="uniq-portfolio section-padding position-re">
        ...
        <div className="row">
          <div className="col-lg-5 valign">
            <div className="text md-mb50">
              ...
              <p>
                <Translatable>
                  Our platform is designed to foster a strong sense of community where members can interact, share, and support each other
                </Translatable>
              </p>
              <br />
              <p>
                <Translatable>
                Post your workout photos, share your progress videos, and engage in discussions with fellow members!
                </Translatable>
              </p>
